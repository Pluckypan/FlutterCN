...
import 'package:fluttercn/pages/left_drawer.dart';
import 'package:fluttercn/pages/webview_page.dart';
...
class Home extends StatefulWidget {
  ...
  static Future gotoReplace(BuildContext context) {
    return RouteManager.goto(context, "/home/${S.of(context).appName}",
        replace: true);
  }
  ...
  List<Widget> _actionView() {
    return <Widget>[
      new IconButton(
        ...
        onPressed: () {
          AboutPage.goto(context, user: User()..name = "Plucky")
              .then((obj) => {print(obj)});
        },
      ),
    ];
